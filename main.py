...
import numpy as np
from pettingzoo.mpe import simple_adversary_v2, simple_spread_v2, simple_tag_v2, simple_speaker_listener_v3
...
def get_env(env_name, ep_len=25):
    ...
    if env_name == 'simple_speaker_listener_v3':
        new_env = simple_speaker_listener_v3.parallel_env(max_cycles=ep_len)
...
if __name__ == '__main__':
    ...
    parser.add_argument('env_name', type=str, default='simple_adversary_v2', help='name of the env',
                        choices=['simple_adversary_v2', 'simple_spread_v2', 'simple_tag_v2', 'simple_speaker_listener_v3'])
